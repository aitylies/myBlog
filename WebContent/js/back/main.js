...
(function($) {
  ...
  /* search
   ...
   var ssSearch = function() {
	   ...
	   searchField.attr({placeholder: 'Entrez vos mots-clés', autocomplete: 'off'});
	...
	* ------------------------------------------------------ */
	var ssAjaxChimp = function() {
		...
		$.ajaxChimp.translations.es = {
		  'submit': 'Submitting...',
		  0: '<i class="fa fa-check"></i> Nous vous avons envoyé une confirmation par e-mail',
		  1: '<i class="fa fa-warning"></i> Vous devez saisir un e-mail valide',
		  2: '<i class="fa fa-warning"></i> E-mail non valide.',
		  3: '<i class="fa fa-warning"></i> E-mail non valide',
		  4: '<i class="fa fa-warning"></i> E-mail non valide',
		  5: '<i class="fa fa-warning"></i> E-mail non valide'
		} 
		...
		$.ajaxChimp.translations.fr = {
		  ...
		  0: '<i class="fa fa-check"></i> Nous vous avons envoyé une confirmation par e-mail',
		  1: '<i class="fa fa-warning"></i> Vous devez saisir un e-mail valide',
		  2: '<i class="fa fa-warning"></i> Une addresse e-mail doit contenir le symbole @.',
		  3: '<i class="fa fa-warning"></i> Le domaine de l\'e-mail est invalide (Partie après le @: )',
		  4: '<i class="fa fa-warning"></i> Le nom de l\'addresse est invalide (Partie avant le @: )',
		  5: '<i class="fa fa-warning"></i> Cette e-mail semble être unvalide. Veuillez saisir unn autre e-mail'
		} 
