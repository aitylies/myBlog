   			...
   			<article class="format-standard">  
					...
					<div class="primary-content">
						...
						<ul class="entry-meta">
							...
							<li class="cat"><a href="">Ylies AIT IHADDADENE</a></li>				
						</ul>						
			...
			<div id="comments" class="row">
               ...
               <div class="respond">
                  ...
                  <form name="contactForm" id="contactForm" method="post" action="">
                     ...
                     <div class="form-field">
  						      <input name="cEmail" type="text" id="cEmail" class="full-width" placeholder="Votre Email" value="">
                     </div>

                     <div class="message form-field">
                        <textarea name="cMessage" id="cMessage" class="full-width" placeholder="Votre commentaire" ></textarea>
                     </div>
